Vue.component('cart', {
    ...
    template: `
    <div>
        <button class="btn-cart" type="button" @click="showCart = !showCart"><span class="btn-cart__text">Корзина</span></button>
...
Vue.component('cart-item', {
    ...
    <div class="cart-item">
                    <div class="product-bio">
                        <img :src="cartItem.img" width=50 alt="cartItem.product_name">
